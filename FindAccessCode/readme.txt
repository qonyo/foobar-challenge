...
chamber is secured with a unique lock system whose number of passcodes changes daily. 
...
in order to make it easier to find them in the lists. 
A "lucky triple" is a tuple (x, y, z) where x divides y and y divides z, 
such as (1, 2, 4). With that information, you can figure out 
which list contains the number of access codes that matches 
the number of locks on the door when you're ready to go in 
...
meet the requirement i < j < k.  The length of l is between 2 and 2000 inclusive.  
