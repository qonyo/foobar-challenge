...
device was completed AND Lambda set a new personal high score in Tetris. 
To celebrate, the Commander ordered cake for everyone -- even the lowliest of minions! 
...
describing the sequence of M&Ms, returns the maximum number of equal parts that can be 
